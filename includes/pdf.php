...
class FPDF
{
    ...
    {
        $file = __DIR__ . '/fonts/' . strtolower($family) . '.php';
        if (!file_exists($file)) {
            $this->Error('Metric file not found: ' . $file);
        }
        include $file;
        return $cw;
    }
